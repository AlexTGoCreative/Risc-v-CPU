...
`define MLEN 15 // 15: 32kB (required for CoreMark; 8kB=13 is enough for darkshell)
...
`ifdef DE2_CYCLONE2
    `define BOARD_ID 21
    `define BOARD_CK 100000000  // 50 MHz input x2 PLL = 100 MHz
    `define INVRES 1            // KEY[0] is active-low reset
`endif
